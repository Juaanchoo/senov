...
class SedeModel extends DataBase
{
	private $db;
    ...
    public function get_One_sede($id)
    {
        try {
    ...
    public function set_sede($datos)
    {
        try {

           $sql="INSERT INTO sede(sede, estado) VALUES (?,?)"; 
    ...
    public function update_sede($datos)
    {
        try {

           $sql="UPDATE `sede` SET sede = ? WHERE id_sede = ?"; 
    ...
    public function deshabilitar_sede($id,$estado)
    {
        try {

           $sql="UPDATE `sede` SET `estado`= ? WHERE id_sede = ?"; 
