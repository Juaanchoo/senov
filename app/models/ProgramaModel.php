...
class ProgramaModel extends DataBase
{
	private $db;
     ...
     */
     ...
     public function get_Programas()
     {
         try {
            ...
            INNER JOIN tipo_formacion AS tf ON pf.fk_id_tipo_formacion=tf.id_tipo_formacion WHERE pf.estado = ?";
    ...
    public function get_One_Programa($id)
    {
        try {
    ...
    public function set_Programas($datos)
    {
        try {
    ...
    public function update_Programa($datos)
    {
        try {
    ...
    public function deshabilitar_Programa($id)
    {
        try {
    ...
    public function habilitar_Programa($id)
    {
        try {
